...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.combined_output_projection = torch.nn.Linear(in_features=3 * hidden_size, out_features=hidden_size,
                                                          bias=False)
        self.target_vocab_projection = torch.nn.Linear (in_features=hidden_size, out_features=len(self.vocab.tgt),
                                                          bias=False)
